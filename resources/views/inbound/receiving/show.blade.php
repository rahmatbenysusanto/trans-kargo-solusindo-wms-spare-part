                            ...
                            <tbody>
                                @foreach ($inbound->details as $detail)
                                    <tr>
                                        ...
                                        <td class="py-2 px-3 small">{{ $detail->parent_sn ?? '-' }}</td>
                                        <td class="py-2 px-3 small">{{ $detail->old_serial_number ?? '-' }}</td>
                                        <td class="py-2 px-3"><span class="fw-bold text-primary"
                                                style="font-size: 0.75rem;">{{ $detail->old_wh_asset_number ?? '-' }}</span>
                                        </td>
                                        <td class="py-2 px-3">
                                            @php
