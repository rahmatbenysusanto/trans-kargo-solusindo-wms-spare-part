...
@section('content')
    <div class="row">
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-primary btn-sm text-white" onclick="submitRelokasi()">Create Relokasi</a>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="Relokasi" readonly>
                        </div>
                        <div class="col-4 mb-3">
    ...
    <script>
        ...
        function submitRelokasi() {
            ...
            if (products.length === 0) {
                Swal.fire('Error', 'Please add at least one product before creating a Relokasi.', 'error');
                return;
            }
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to create this Relokasi?",
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('{{ route('receiving.store.relokasi') }}', {
                            method: 'POST',
                            headers: {
                        ...
                        .then(data => {
                            if (data.status) {
                                ...
                                Swal.fire({
                                    title: 'Success!',
                                    text: 'Your Relokasi has been created successfully.',
                                    icon: 'success'
                                }).then(() => {
                                    window.location.href = '{{ route('receiving') }}';
                                });
                            } else {
                                Swal.fire('Error', data.message || 'Failed to create Relokasi.', 'error');
                            }
                        })
                        .catch(error => {
