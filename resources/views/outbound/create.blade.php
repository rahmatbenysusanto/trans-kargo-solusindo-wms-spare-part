...
@section('js')
    <script>
        ...
        const DEFAULT_REQUEST_TYPE = '{{ $defaultRequestType }}';

        function renderProducts() {
            const products = JSON.parse(localStorage.getItem('outbound_temp_products')) ?? [];
        ...
        function updateOldSn(index, value) {
            ...
            if (products[index]) {
                ...
                localStorage.setItem('outbound_temp_products', JSON.stringify(products));
            }
        }
        ...
        function submitOutbound() {
            ...
            // Enhanced validation for RMA/Faulty
            if ((category === 'RMA' || category === 'Faulty') && (!data.rma_number || !data.itsm_number)) {
                Swal.fire({
                    title: 'Validation Failed',
                    text: 'RMA# and ITSM# are required for this category.',
                    icon: 'warning',
                    customClass: {
                        confirmButton: 'btn btn-primary'
                    },
            ...
            // Adjust products for Write-off
            if (category === 'Spare Write Off') {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(STORE_URL, {
                        ...
                        .then(res => {
                            if (res.status) {
                                localStorage.removeItem('outbound_temp_products');
                                Swal.fire({
                                    title: 'Success!',
                                    text: 'Outbound recorded successfully.',
                                    icon: 'success',
                                    customClass: {
                                        confirmButton: 'btn btn-primary'
                                    },
        ...
        function updateRequestType() {
            const categoryMapping = {
                'Spare Write Off': 'Spare Write Off',
                'Spare from/to Loan': 'Loan',
                'RMA': 'RMA',
                'Faulty': 'RMA',
                'Spare from/to Replacement': 'RMA'
            };
            const category = document.getElementById('category').value;
            const requestTypeSelect = document.getElementById('request_type');
            if (requestTypeSelect) {
                requestTypeSelect.value = categoryMapping[category] || 'RMA';
            }
                    ...
                    <div
                        ...
                        <div class="me-3">
                            <h4 class="mb-1 text-primary fw-bold">
                                <i class="ti tabler-arrow-up-right me-2"></i>{{ $title }}
                            </h4>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm bg-white p-3 h-100"
                                    ...
                                    <h6 class="fw-bold mb-3 d-flex align-items-center text-primary"><i
                                            class="ti tabler-info-square-rounded me-2"></i> Transaction Detail</h6>
                                    <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm bg-white p-3 h-100"
                                    style="border-radius: 12px; border: 1px solid rgba(115, 103, 240, 0.08) !important;">
                                    <h6 class="fw-bold mb-3 d-flex align-items-center text-primary"><i
                                            class="ti tabler-file-description me-2"></i> Request & PO</h6>
                                    <div class="mb-3">
                            ...
                            <!-- Column 3: Dispatch & Shipping -->
                            <div class="col-md-4">
                                <div class="card border-0 shadow-sm bg-white p-3 h-100"
                                    style="border-radius: 12px; border: 1px solid rgba(115, 103, 240, 0.08) !important;">
                                    <h6 class="fw-bold mb-3 d-flex align-items-center text-primary"><i
                                            class="ti tabler-truck-delivery me-2"></i> Dispatch & Shipping</h6>
                                    <div class="row g-2">
            ...
            <div class="col-12">
                <div class="card border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
                    <div class="card-header bg-white py-4 px-4 d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1 fw-bold text-dark"><i class="ti tabler-box-seam me-2 text-primary"></i>
                                Selected Items</h5>
